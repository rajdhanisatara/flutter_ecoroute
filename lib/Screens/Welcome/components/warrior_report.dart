        ...
        child: DropdownButton<String>(
          ...
          selectedItemBuilder: (BuildContext context) {
            return const [
              DropdownMenuItem<String>(
                value: 'Citizens Misbehavior',
                child: Text('Citizens Misbehavior', style: TextStyle(fontSize: 25)),
              ),
              DropdownMenuItem<String>(
                value: 'Road Block/Traffic',
                child: Text('Road Block/Traffic', style: TextStyle(fontSize: 24)),
              ),
              DropdownMenuItem<String>(
                value: 'App Mal-functioning',
                child: Text('App Mal-functioning', style: TextStyle(fontSize: 25)),
              ),
              DropdownMenuItem<String>(
                value: 'Vehicle Malfunctioning',
